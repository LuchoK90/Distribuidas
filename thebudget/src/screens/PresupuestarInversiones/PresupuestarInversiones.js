...
import SelectPresupuestoCategoriaInversion from '../../components/SelectPresupuestoCategoriaInversion/SelectPresupuestoCategoriaInversion';
    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.infoRecipeContainer}>
          ...
          <SelectPresupuestoCategoriaInversion/>
