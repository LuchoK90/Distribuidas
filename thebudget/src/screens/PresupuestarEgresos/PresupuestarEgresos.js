...
import SelectPresupuestoCategoriaEgreso from '../../components/SelectPresupuestoCategoriaEgreso/SelectPresupuestoCategoriaEgreso';
    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.infoRecipeContainer}>
          ...
          <SelectPresupuestoCategoriaEgreso/>
